...
import { clearAdminData } from "../../features/auth/authSlice";
...
const AdminLayout = () => {
  ...
  const sidebarLinks = [
    { name: "Verify Sellers", path: "/admin", icon: <BsPersonCheck /> },
    {
      name: "Add Category",
    ...
    { name: "Orders", path: "/admin/orders", icon: <PiCalendarCheckLight /> },
  ];
